...
const Home = () => {
  ...
  return (
    <div className="px-4">
      <div className="flex flex-col items-center lg:flex-row gap-8 sm:gap-14 px-4 sm:px-14 pb-10 sm:pb-20">
        <div
      ...
      <div className="py-10 sm:py-12 md:py-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-8">
        <div
          ...
          data-aos="fade-up"
        >
          <FaReact className="text-6xl sm:text-8xl mx-auto mb-4 text-sky-600" />
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <FaNodeJs className="text-6xl sm:text-8xl mx-auto mb-4 text-sky-600" />
          <div className="grid gap-2">
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <FaDatabase className="text-6xl sm:text-8xl mx-auto mb-4 text-sky-600" />
          <div className="grid gap-2">
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <FaCloud className="text-6xl sm:text-8xl mx-auto mb-4 text-sky-600" />
          <div className="grid gap-2">
